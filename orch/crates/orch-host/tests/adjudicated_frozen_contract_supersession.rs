...
//! | 原 M8 | B328 退役永久 landed 准入；当前 seed/域约束由 recorded_seed_evolution_v1 的真实机检覆盖 | 历史源字节不变 |
...
// B328: the old permanent-landed source assertion is retired. Actual current seed and
// successor authorization are checked by recorded_seed_evolution_v1.
