//! B165 seeded-red contract (H30: once the plan is signed off, consultation freezes).
//!
//! Negative mutations that must turn the named case red:
//! M1. Ignore PlanSignedOff and admit during delivery. Consultation is a
//!     plan-phase tool by the user's explicit boundary; a signed-off round is
//!     already executing against a frozen contract.
...
#[test]
fn a_signed_off_round_refuses_and_an_unsigned_plan_admits() {
...
#[test]
fn a_replanned_or_closed_round_admits_consultation_again() {
...
#[test]
fn a_refusal_leaves_one_log_line_and_nothing_else() {
