...
fn append_incident(root: &PathBuf) -> String {
    ...
    let continuation = "review:r58:B176:B176-A0002:review:executor-opencode";
    ...
    ledger::append(root, "r58", &[opened, wake, review, rejected]).unwrap();
    wake_id.to_string()
}
